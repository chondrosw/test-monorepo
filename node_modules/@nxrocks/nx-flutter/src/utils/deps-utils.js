...
function getPackageInfo(project) {
    if (fileutils_1.fileExists(common_1.getProjectFilePath(project, 'pubspec.yaml'))) { //
        const pubspec = js_yaml_1.load(common_1.getProjectFileContent(project, 'pubspec.yaml'));
        const dependencies = [];
    ...
    throw new Error(`Cannot inspect dependencies of Flutter projet at: '${common_1.getProjectRoot(project)}'.\n` +
