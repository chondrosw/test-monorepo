...
class Cache {
    ...
    put(task, terminalOutput, outputs, code) {
        return (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return this.tryAndRetry(() => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
                ...
                yield Promise.all(outputs.map((f) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
    ...
    copy(src, directory) {
        ...
        return new Promise((res, rej) => {
            (0, child_process_1.exec)(`cp -a "${src}" "${(0, path_1.dirname)(directory)}"`, (error) => {
                if (!error) {
                    res();
                }
                else {
    ...
    remove(folder) {
        ...
        return new Promise((res, rej) => {
            (0, child_process_1.exec)(`rm -rf "${folder}"`, (error) => {
                if (!error) {
                    res();
                }
                else {
    ...
    tryAndRetry(fn) {
        ...
        const _try = () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            try {
                attempts++;
                return yield fn();
            }
