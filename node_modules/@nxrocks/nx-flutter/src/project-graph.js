...
const deps_utils_1 = require("./utils/deps-utils");
...
function processProjectGraph(graph, context) {
    return common_1.getProjectGraph(common_1.NX_FLUTTER_PKG, flutter_utils_1.isFlutterProject, deps_utils_1.getPackageInfo, graph, context);
}
